...
def main():
    parser = argparse.ArgumentParser(description="Test real OIDC login with matrix-locust")
    parser.add_argument("--homeserver", "-s", default="http://localhost:8008",
    ...
    logger.info("=" * 50)
    logger.info("Credentials will be read from NITROID_USERNAME and NITROID_PASSWORD environment variables")
